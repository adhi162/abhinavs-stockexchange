...
// USDT to NPR exchange rate
const USDT_RATE = 133.20;
...
export const Hero = () => {
  ...
  const calculatedAmount = useMemo(() => {
    ...
    const result = numAmount * USDT_RATE;
        ...
        <div className="space-y-8 lg:w-1/2">
          ...
          <div data-animate="fade-up" data-animate-delay="80">
            ...
            <p className="mt-6 text-lg leading-relaxed text-white/80">
              Swap USDT into Nepali Rupee through a private desk that moves with you. Same-day settlements, concierge delivery, and regulatory compliance support in one place.
            </p>
          </div>
          ...
          <div className="rounded-[32px] border border-white/20 bg-white/90 p-8 text-slate-900 shadow-[0_25px_80px_rgba(2,6,23,0.35)] backdrop-blur">
            <div className="mb-6 flex items-center justify-between">
              <div>
                ...
                <h2 className="text-2xl font-semibold text-slate-900">USDT to NPR</h2>
              </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="rounded-2xl bg-white p-4 shadow-inner">
                    ...
                    <input
                      ...
                      placeholder="0"
                    />
                    <p className="text-sm text-slate-500 mt-2">USDT</p>
                  </div>
                  <div className="rounded-2xl bg-white p-4 shadow-inner">
