...
export const ExchangeCalculator = () => {
  ...
  // Load USDT rate from dataService
  useEffect(() => {
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 text-3xl font-semibold text-slate-900 sm:text-4xl">
            Exchange USDT to Nepalese Rupee
          </h2>
          <p className="mt-4 text-lg text-slate-600">
            Enter the amount and we'll confirm the final rate via WhatsApp or Telegram within minutes.
          </p>
        </div>
        ...
        <Card className="mt-12 border border-white/70 bg-white/85 p-10 shadow-2xl shadow-slate-200/70 backdrop-blur">
          <div className="space-y-8">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                ...
                <Input
                  ...
                  placeholder="1000"
                />
                <p className="mt-2 text-xs text-slate-500">Enter amount in USDT</p>
              </div>
              <div>
                ...
                <p className="mt-2 text-xs text-slate-500 text-center">
                  Rate: 1 USDT = {parseFloat(usdtRate).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} NPR
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              >
                <a
                  href={`https://wa.me/9779841234567?text=Hi%20Senate%2C%20I%20want%20to%20exchange%20${amount.replace(/\s/g, "")}%20USDT%20via%20${deliveryMethod}.`}
                  target="_blank"
                  rel="noreferrer"
                >
