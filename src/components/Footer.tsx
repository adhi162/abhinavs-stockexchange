...
export const Footer = () => {
  const [officeLocation, setOfficeLocation] = useState(() => {
    ...
    return dataService.getOfficeLocation();
  });

  useEffect(() => {
    // Listen for storage changes to update location in real-time
    const handleStorageChange = () => {
      setOfficeLocation(dataService.getOfficeLocation());
    };
        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_1fr_1fr_1fr]">
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Button asChild size="sm" className="rounded-full px-4">
                <a href="https://wa.me/918546937677" target="_blank" rel="noreferrer">
          ...
          <FooterGroup title="Contact">
            <div className="space-y-3 text-sm">
              <a href="tel:+918546937677" className="flex items-center gap-2 font-semibold text-slate-900">
